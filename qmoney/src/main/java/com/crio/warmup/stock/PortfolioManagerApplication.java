...
public class PortfolioManagerApplication {
  ...
  public static List<AnnualizedReturn> mainCalculateReturnsAfterRefactor(String[] args)
    ...
    File fobject = resolveFileFromResources(file);
    ObjectMapper obmapper = getObjectMapper();
    List<PortfolioTrade> pf
        = obmapper.readValue(fobject, new TypeReference<List<PortfolioTrade>>(){});
    //PortfolioManagerFactory obj = new PortfolioManagerFactory();
    PortfolioManager builderobj = PortfolioManagerFactory.getPortfolioManager(new RestTemplate());
    return builderobj.calculateAnnualizedReturn(pf, endDate);
  }
